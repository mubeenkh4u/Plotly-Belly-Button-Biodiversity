...
function buildCharts(sample) {
  ...
  d3.json("./static/js/samples.json").then((data) => {
    ...
    var firstelement = chartArray[0];

    // 6. Create variables that hold the otu_ids, otu_labels, and sample_values.
    var Ids = firstelement.otu_ids;
    var Labels = firstelement.otu_labels;
    var sampleValues = firstelement.sample_values;
...
// ****************** Deliverable #2 ****************** 
    ...
    var bubbleLayout = {
      title: "<b> Bacteria Cultures for Sample </b>",
      xaxis: {title: "OTU ID"},
      hovermode: "closest",
